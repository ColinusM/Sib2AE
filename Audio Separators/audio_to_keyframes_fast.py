...
def process_single_audio_file(args):
    ...
    try:
        ...
        # Create instrument directory in keyframes folder
        keyframes_base_dir = os.path.join(output_dir, "Keyframes")
...
def process_audio_directory_fast(audio_dir: str):
    ...
    # Create keyframes base directory
    keyframes_base_dir = os.path.join(audio_dir, "Keyframes")
