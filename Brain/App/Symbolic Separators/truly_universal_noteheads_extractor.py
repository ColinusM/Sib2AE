...
def main():
    ...
    import os
    os.makedirs("outputs/svg/noteheads", exist_ok=True)

    # Generate output filename in new location
    base_name = os.path.basename(musicxml_file).replace('.musicxml', '')
    output_file = f"outputs/svg/noteheads/{base_name}_noteheads_universal.svg"
